...
int main()
{
    ...
    {
        string ss;
        string smp = "";
        cin >> ss;
        f = 0;
        cnt = 0;
        k = 0;
        ...
        {
            if (i + ss.size() - 1 < smp.size() && smp.substr(i, ss.size()) == ss){
                f = 1;
                break;
            }
        }
